...
<div class="container mt-4" style="max-width:800px">
    <h2><i class="bi bi-pencil"></i> Edit Field — <span class="text-primary">@Model.DisplayName</span></h2>
    <hr />
    @Using Html.BeginForm()
        @Html.AntiForgeryToken()
        @Html.HiddenFor(Function(m) m.FieldId)
        @Html.HiddenFor(Function(m) m.ListId)
        @Html.HiddenFor(Function(m) m.InternalName)
            ...
            <div class="card-body">
                <div class="row mb-3">
                    ...
                    <div class="col-md-6">
                        ...
                        @Html.DropDownListFor(Function(m) m.DataType,
                            dataTypes.Select(Function(d) New SelectListItem With {.Text = d, .Value = d, .Selected = (d = Model.DataType)}),
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-6">
                        ...
                        @Html.TextBoxFor(Function(m) m.ValidationRule, New With {.class = "form-control"})
                    </div>
                </div>
                <div class="row mb-3">
                    <div class="col-md-3">
                    ...
                    <div class="col-md-6">
                        @Html.LabelFor(Function(m) m.RegexValidation, New With {.class = "form-label fw-bold"})
                        @Html.TextBoxFor(Function(m) m.RegexValidation, New With {.class = "form-control", .placeholder = "Regex pattern"})
                    </div>
                </div>
                <div class="row mb-3">
                    <div class="col-12">
